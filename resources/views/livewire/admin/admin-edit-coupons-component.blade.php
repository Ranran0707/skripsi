                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="updateCoupon">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control input-md" placeholder="Coupon Code"
                                        wire:model="code">
                                    @error('code')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control input-md" placeholder="Coupon Value"
                                        wire:model="value">
                                    @error('value')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control input-md" placeholder="Cart Value"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4" wire:ignore>
                                    <input type="text" id="expiry-date" class="form-control input-md"
